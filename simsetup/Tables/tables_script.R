...
sel_prob <- c("ctjb", "ctsamh", "bsamh", "hsamh", "hbsamh")
...
data |>
  ...
  footnote(general = paste0("\\\\rule{0pt}{1.75em}\\\\makecell[l]{$^\\\\ast$",
                            "The Gaussian method employs a sample covariance\\\\\\\\ with multi-step residuals.",
                            "}"), 
...
rbind(crps_0, crps_k) |>
  ...
  pack_rows(paste0("} & \\multicolumn{5}{c}{\\\\textbf{", K[3], "}} & \\\\multicolumn{5}{c}{"), 
