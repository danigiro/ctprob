...
\begin{proof}
	...
	\begin{align*}
		...
		& = \lim_{L\rightarrow\infty} \sum_{\ell = 1}^L \mathbbm{1}\left\{\psi\left(\widehat{\xvet}_\ell\right) \in \mathcal{A}\right\} = \text{Pr}\left(\widetilde{\xvet} \in \psi^{-1}\left(\mathcal{A}\right) \right)
	\end{align*}
\end{proof}
