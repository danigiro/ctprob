...
\end{tikzpicture}
	\endgroup
	\caption{{\color{red}\sout{Visual description}} {\color{blue}Overview} of cross-temporal forecast reconciliation in the Gaussian framework{\color{blue}: two different but equivalent ways of obtaining reconciled forecast samples}, as described in Section \ref{ssec:prob_pf}. The acronyms R.F and B.F. stand for Reconciled and Base Forecasts, respectively. HF-BTS stands for High Frequency Bottom Time Series.}
